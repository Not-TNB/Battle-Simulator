              ...
              if item == 'communism':
                ...
                if f1.hunger < 65:
                  ...
                  if foodType == 1:
                    ...
                    self.events += f', {Fore.GREEN}it was the best meal they had thus recovering 30 hunger{Fore.RESET}\n'
                    f1.hunger += 30
                  else:
                    saturation = random.randint(10,20)
                    self.events += f' and ate it thus recovering {Fore.GREEN}{str(saturation)} hunger{Fore.RESET}\n'
                    f1.hunger += saturation
                else:
                  self.events += ' but ignored it since they weren\'t hungry\n'
              else:
                self.events += '\n'
